...
let SessionsController = class SessionsController {
    ...
    getAllSessions(params) {
        const conference = this.conferenceDataService.getConference(parseInt(params.id, 10));
        return conference.sessions;
    }
    getSession(params) {
        const conference = this.conferenceDataService.getConference(parseInt(params.id, 10));
        return conference.sessions.find((session) => session.id === parseInt(params.sessionId, 10));
    }
};
__decorate([
    common_1.Get(),
...
SessionsController = __decorate([
    common_1.Controller('conferences/:id/sessions'),
